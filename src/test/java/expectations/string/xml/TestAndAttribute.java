...
public class TestAndAttribute {
    ...
    @Test
    public void expectAndAttrinuteToPassWhenXMLHasSingleElementWithAttribute() throws Exception {
        String xml = "<record type=\"person\"><field id=\"2345\">John Doe</field></record>";
        expect(xml).isXml().withField("field").andAttribute("id", "2345");
    }

    @Test
    public void expectAndAttrinuteToFailWhenXMLHasSingleElementWithoutAttribute() throws Exception {
        String xml = "<record type=\"person\"><field id=\"2345\">John Doe</field></record>";
